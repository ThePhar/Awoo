...
import { gameAddPlayer } from "../../actions/game/creators";
...
export default class JoinCommand extends Command {
  public constructor(client: Manager) {
    super(client, {
      ...
      name: CommandType.Join,
      group: "game",
      memberName: CommandType.Join,
  ...
  public async run(message: CommandoMessage): Promise<Message | Message[]> {
    ...
    store.dispatch(gameAddPlayer(playerID, message.member.displayName));
    game = store.getState();
