...
export default {
    ...
    werewolf: {
        ...
        roleNotification: {
            ...
            description:
                "You are a werewolf and learn the identity of all other werewolves, if any. Every night, eliminate a villager and avoid suspicion.",
            actions:
    ...
    seer: {
        ...
        roleNotification: {
            ...
            description:
                "You are a seer and can learn the true identity of any player at night. Take care to protect your identity as you are the werewolves' biggest threat.",
            actions:
    ...
    lycan: {
        ...
        roleNotification: {
            ...
            description:
                "You are a villager that has been cursed with mild lycanthropy and will appear to the seer as a werewolf.",
        },
    },
    mayor: {
        name: "Mayor",
        ...
        roleNotification: {
            ...
            description:
                "As mayor of this village, your votes to lynch players will be counted twice. That's democracy at work after all.",
        },
    },
    tanner: {
        name: "Tanner",
    ...
    sorceress: {
        ...
        roleNotification: {
            ...
            description:
                "You are a sorceress and can learn if a player is a seer. Use that information to help the werewolves destroy this village.",
            actions:
    ...
    minion: {
        ...
        roleNotification: {
            ...
            description:
                "You are a minion and learn the identity of all the werewolves. Assist the werewolves to destroy this village.",
        },
    },
    drunk: {
        name: "Drunk",
    ...
    mason: {
        ...
        roleNotification: {
            ...
            description:
                "You are a Mason and learn the identity of the other Mason. This is the only person you can truly trust.",
        },
    },
    loneWolf: {
        name: "Lone Wolf",
        ...
        roleNotification: {
            ...
            description:
                "You are a lone wolf and learn the identity of all other werewolves. Every night, eliminate a villager and avoid suspicion. You must be the only survivor, so even your fellow werewolves must be eliminated.",
            fields: [
                {
                    name: "Objective",
    ...
    apprenticeSeer: {
        ...
        roleNotification: {
            ...
            thumbnail:
                "https://cdn.discordapp.com/attachments/429907716165730308/668771392363429898/apprentice_seer.png",
    ...
    doppelganger: {
        ...
        roleNotification: {
            ...
            description:
                "You are a doppelgänger and become the role of a player of your choice if they are eliminated.",
            actions:
