...
export function noLynch(game: Game, votes: { player: Player; count: number }[]): Discord.MessageEmbed {
    ...
    const lynchVotes = game.players.alive.map((player) => {
        if (player.accusing) {
            return `${player} voted to lynch ${player.accusing}`;
        }
    ...
    `),
        ...
        .addField("Total Lynch Votes", safeArray(totalLynchVotes), true)
        .addField("Lynch Votes", safeArray(lynchVotes), true);
}
...
export function villagerWin(game: Game): Discord.MessageEmbed {
    ...
    return new Discord.MessageEmbed()
        ...
        .setColor(Color.VillagerBlue)
        .setFooter(Tip())
        .addField("Winning Team", safeArray(winners), true)
        .addField("Losing Teams", safeArray(losers), true);
}
...
export function tannerWin(game: Game): Discord.MessageEmbed {
    ...
    return new Discord.MessageEmbed()
        ...
        .setFooter(Tip())
        .addField("Winner", safeArray(winners), true)
        .addField("Losers", safeArray(losers), true);
}
