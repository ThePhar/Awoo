...
import GameManager from "../struct/gameManager"
 ...
 * @param game
 */
export default function fullAnnouncementEmbed(game: GameManager): D.MessageEmbed {
 ...
 * @param game
 */
export function summaryEmbed(game: GameManager): D.MessageEmbed {
    return new D.MessageEmbed()
        .setColor(Color.Default)
}
