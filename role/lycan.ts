...
export class Lycan extends Role {
  ...
  public get team(): Team { return this._team || Lycan.team }
  public get name(): string { return this._name || Lycan.roleName }
  public get appearance(): Appearance { return this._appearance || Lycan.appearance }
